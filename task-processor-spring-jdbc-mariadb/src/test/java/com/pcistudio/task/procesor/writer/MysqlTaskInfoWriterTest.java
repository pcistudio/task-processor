...
class MysqlTaskInfoWriterTest {
    ...
    public static class JdbcTemplateConfig {
        ...
        @Bean
        MariadbTaskStorageSetup mysqlTaskStorageSetup(JdbcTemplate jdbcTemplate) {
            MariadbTaskStorageSetup taskStorageSetup = new MariadbTaskStorageSetup(jdbcTemplate);
    ...
    @Test
    void writeTasks() {
        TaskInfoWriter mysqlTaskInfoWriter = new MariadbTaskInfoWriter(jdbcTemplate, StorageResolver.IDENTITY);
